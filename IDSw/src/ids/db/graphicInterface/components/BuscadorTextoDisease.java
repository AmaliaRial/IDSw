...
public class BuscadorTextoDisease extends JPanel {
    ...
    private void buscarTexto() {
        ...
        ArrayList<Disease> datos = (ArrayList<Disease>) this.conMan.getDiseaseMan().listMatchingDiseaseByName(textoBuscar);

        // Limpiar el modelo de la lista
        listModel.clear();

        // Buscar coincidencias
        for (Disease item : datos) {
            listModel.addElement(item.getNameDisease());
        }
    }
    ...
    public static void main(String[] args) {
        ...
        frame.add(new BuscadorTextoDisease(), BorderLayout.CENTER);

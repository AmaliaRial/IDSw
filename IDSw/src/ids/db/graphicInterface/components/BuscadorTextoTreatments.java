...
public class BuscadorTextoTreatments extends JPanel {
    ...
    public BuscadorTextoTreatments() {
    ...
    private void buscarTexto() {
        ...
        ArrayList<Treatment> datos = (ArrayList<Treatment>) this.conMan.getTreatmentMan().listMatchingTreatmentsByName(textoBuscar);

        // Limpiar el modelo de la lista
        listModel.clear();

        // Buscar coincidencias
        for (Treatment item : datos) {
            listModel.addElement(item.getNameTreatment());
        }
    }
    ...
    public void agregarSeleccion(String seleccion) {
        ...
        cancelarButton.setPreferredSize(new Dimension(90, 20));
 ...
 // Método para obtener las selecciones actuales
    ...
    public static void main(String[] args) {
        ...
        frame.add(new BuscadorTextoTreatments(), BorderLayout.CENTER);
